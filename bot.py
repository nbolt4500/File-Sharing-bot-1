        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/kratosXmania"),
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Follow For Adult Content",
                                             url="https://t.me/kratosXmania")
                    ],
                    [
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/kratosXmania")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs"),
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/KRATOSXXmania"),
                        InlineKeyboardButton("Main Channel", url="https://t.me/kratosXmania")
                    ]
                ]
            )
        )
